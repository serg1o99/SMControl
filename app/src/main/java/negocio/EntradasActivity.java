...
import com.example.smcontrol.GestionarProducto;
...
public class EntradasActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productoAdapter = new ProductoAdapter(EntradasActivity.this,listaProducto);
